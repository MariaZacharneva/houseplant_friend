...
- pin_list:
  ...
  - {pin_num: L13, peripheral: ADC2, signal: 'IN, 15', pin_signal: GPIO_AD_B1_10, identifier: ''}
  - {pin_num: L13, peripheral: CMP4, signal: 'IN, 5', pin_signal: GPIO_AD_B1_10, identifier: ''}
